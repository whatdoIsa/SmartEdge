...
def add_file_to_xcode_project():
    ...
    filename = 'NotchModels.swift'
    filepath = 'SmartEdge/Shared/Models/NotchModels.swift'
    ...
    if pbx_file_ref_start != -1:
        ...
        file_ref_line = f'\t\t{file_ref_id} /* {filename} */ = {{isa = PBXFileReference; lastKnownFileType = sourcecode.swift; path = "{filepath}"; sourceTree = "<group>"; }};\n'
    ...
    if sources_match:
        ...
        # Add our build file to the sources

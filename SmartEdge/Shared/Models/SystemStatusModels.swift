...
// Import BluetoothDevice type from protocol file
// Note: This creates a dependency from Shared/Models to Core/Protocols
// In a clean architecture this would be resolved by moving BluetoothDevice to Shared/Models
// For now, we import to resolve the type ambiguity
